...
// let autoblck =JSON.parse(fs.readFileSync('../database/autoblock.json'));
...
const imageDirectory = '../Assets/logo';
...
break;
            ...
            case 'clearsession': {
                ...
                fs.readdir("../database/session", async function(err, files) {
                    if (err) {
                    ...
                    await filteredArray.forEach(function(file) {
                        fs.unlinkSync(`../database/session/${file}`)
                    });
                    await sleep(2000)
...
/////////////////////////////////////_//////////////
      ...
      case 'toge':
        ...
        Maria.sendMessage(m.chat, { image: { url: "https://telegra.ph/file/7bcf26333d5b78e78f238.jpg" }, caption: txxt}, { quoted: m });
      ...
      case "info":
            Maria.sendMessage(from, { react: { text: "", key: m.key }}) 
        let pifx = `*TOGE-MD-V3:* https://github.com/toge012345/TOGE-MD-V3\n\n\n*TOGE-MD-V2 :* https://github.com/toge012345/TOGE-MD-V2\n\n\n*GROUP:* https://chat.whatsapp.com/JQ4s2pJuBReE7YL9wKJPHo\n\n\n*CHANEL:* https://whatsapp.com/channel/0029VaiuD4s4IBhI0fzbv40Z`
...
┗━━━━━━━━━━━━━━━⊛ 
`
        Maria.sendMessage(m.chat, { image: { url: "../Assets/nsfw.jpg" }, caption: nsfwmenu }, { quoted: m });
        break;
        ...
        interactiveMessage: proto.Message.InteractiveMessage.create({
          ...
          footer: proto.Message.InteractiveMessage.Footer.create({
            text: botname
                    ...
                    header: proto.Message.InteractiveMessage.Header.create({
                ...(await prepareWAMessageMedia({ image : fs.readFileSync('../Assets/list.jpg')}, { upload: Maria.waUploadToServer})), 
            title: generalmenu,
            subtitle: themeemoji,
            hasMediaAttachment: false
          }),
...
case 'cum':
 if (!m.isGroup) return reply(mess.group);
   if (!isNsfw) return reply(mess.nsfw);
var ahegaonsfw = JSON.parse(fs.readFileSync('../database/nsfw/cum.json'))
var Mariayresult = pickRandom(ahegaonsfw)Maria.sendMessage(m.chat, { caption: mess.done, image: { url: Mariayresult.url } }, { quoted: m })
break;
...
case 'gangbang':
 if (!m.isGroup) return reply(mess.group);
   if (!isNsfw) return reply(mess.nsfw);
var ahegaonsfw = JSON.parse(fs.readFileSync('../database/nsfw/gangbang.json'))
var Mariayresult = pickRandom(ahegaonsfw)
Maria.sendMessage(m.chat, { caption: mess.done, image: { url: Mariayresult.url } }, { quoted: m })
break;
...
case 'hentai':
 if (!m.isGroup) return reply(mess.group);
   if (!isNsfw) return reply(mess.nsfw);
var ahegaonsfw = JSON.parse(fs.readFileSync('../database/nsfw/hentai.json'))
var Mariayresult = pickRandom(ahegaonsfw)
Maria.sendMessage(m.chat, { caption: mess.done, image: { url: Mariayresult.url } }, { quoted: m })
break;
...
case 'ass':
 if (!m.isGroup) return reply(mess.group);  
 if (!isNsfw) return reply(mess.nsfw);
var ahegaonsfw = JSON.parse(fs.readFileSync('../database/nsfw/ass.json'))
var Mariayresult = pickRandom(ahegaonsfw)
Maria.sendMessage(m.chat, { caption: mess.done, image: { url: Mariayresult.url } }, { quoted: m })
break;
...
https://chat.whatsapp.com/${response}
 ...
 case 'p':
case 'ping': 
    let thumbnail = '../Assets/thumb.jpg';
    let fgg = {
