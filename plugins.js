...
const { smsg, isUrl, generateMessageTag, getBuffer, getSizeMedia, fetch, await, sleep, reSize } = require('./Media/lib/myfunc.js')
...
Maria.sendMessage(Maria.user.id, {
    text: `𝚃𝙾𝙶𝙴-𝙼𝙳-𝚅𝟹 𝙲𝙾𝙽𝙽𝙴𝙲𝚃𝙴𝙳

ᴘʀᴇꜰɪx: [ ${prefix} ]\n
ᴄᴏᴍᴍᴀɴᴅꜱ: 246\n
ᴠᴇʀꜱɪᴏɴ: 3.0\n
ᴄʀᴇᴀᴛᴏʀ: 𓆩𝐓𝐎𝐆𝐄𓆪 ✇ ◤✞𝐈𝐍𝐔𝐌𝐀𝐊𝐈\n
